...
* [Output files](#output)
  ...
  * [Result 2 file](#out2)
    * [Example](#out2example)
* [Q&A](#qa)
  * [1. If I have the VCF file generated by Freebayes/GATK, how can I transfer the VCF into BSA format?](#vcf2bsa)
...
### <a name="out2"></a>Result 2 file
  This file shows the information of candidate QTLs (significant AFD peaks). It contains six columns. In some cases, users may be required to judge the reasonable peaks among the list with the eyes.
